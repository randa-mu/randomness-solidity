...
contract ChainlinkVRFV2PlusWrapperStub is ConfirmedOwner, ITypeAndVersion, VRFConsumerBaseV2Plus, IVRFV2PlusWrapper {
    ...
    function _calculateRequestPrice(uint256 _gas, uint32 _numWords, uint256 _requestGasPrice, int256 _weiPerUnitLink)
        internal
        view
        returns (uint256)
    {
